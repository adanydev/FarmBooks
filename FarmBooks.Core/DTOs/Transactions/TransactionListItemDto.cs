...
public sealed class TransactionListItemDto
{
    ...
    public string CodesSummary { get; set; } = "Uncoded";

    public string CodesToolTip { get; set; } = "No accounting coding lines.";

    public decimal AllocatedTotal { get; set; }

    public decimal RemainingTotal { get; set; }

    public IReadOnlyList<TransactionLineItemDto> LineItems { get; set; } = [];
